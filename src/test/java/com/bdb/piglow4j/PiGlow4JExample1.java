...
public class PiGlow4JExample1 {
    public static final void main(String args[]) {
        ...
        try {
            ...
            PiGlowBlinker rightBlinker = new PiGlowBlinker(  0, 300, 0, 255, 5, true, true, 2, PiGlowLED.armLEDs(PiGlowArm.RIGHT));
            PiGlowBlinker topBlinker =   new PiGlowBlinker(200, 300, 0, 255, 5, true, true, 2, PiGlowLED.armLEDs(PiGlowArm.TOP));
